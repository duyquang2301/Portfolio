            ...
            <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:max-w-3xl mx-auto">
                <div class="lg:py-6">
                    <div class="text-center lg:text-left">
                        <h1 class="pt-1 text-black font-medium text-4xl md:text-5xl lg:text-6xl italic" :style="{ fontFamily: 'Grechen Fuemen, sans-serif' }">
                            I'M, DUY QUANG
                        </h1>
                    </div>
                    <p class="text-[#868e96] pt-8 text-center lg:text-left mx-auto max-w-xl"> 
                        Backend Developer 💻 focused on building scalable, secure server-side solutions. 
                        Experienced in robust APIs, database optimization, and cloud deployment on AWS. 
                        Proficient in Node.js, Python, Java, Express, and Django. 
                        Committed to leveraging cloud-native tools for innovative, high-availability systems. 🚀  </p>
                    <div class="flex items-center gap-3 pt-9 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0">
                        ...
                        <button class=" border border-primary px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex justify-center">
                            ...
                            <a href="@/assets/CV_TranDuyQuang.pdf" download="CV_TranDuyQuang.pdf" class="pl-2 text-primary"> Download resume</a>
                            </div>
                        </button>
                    </div>
                </div>
